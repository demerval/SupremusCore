    ...
    for (let campoConsulta of criterios) {
      ...
      switch (campoConsulta.operador) {
        case Operador.CONTEM:
          consulta.push(`${campo.name.toUpperCase()}${collate} LIKE ? ${campoConsulta.comparador}`);
          break;
        case Operador.INICIA_COM:
          consulta.push(`${campo.name.toUpperCase()}${collate} LIKE ? ${campoConsulta.comparador}`);
          break;
        case Operador.INTERVALO:
          consulta.push(`${campo.name.toUpperCase()}${collate} BETWEEN ? AND ? ${campoConsulta.comparador}`);
          break;
        default:
          consulta.push(`${campo.name.toUpperCase()}${collate} ${campoConsulta.operador} ? ${campoConsulta.comparador}`);
      }
